...
const {
  ...
  readLog,
  nextStep, readStep,
  addUnit, removeUnit, readUnits, updateUnitMen, updateUnitsRawInitiative, updateUnitCoordinates, updateUnitHd, updateUnitFatigue, updateUnitNotes, updateUnitTypeInitiative, reorderUnitsByInitiative, killUnit, reviveUnit,
...
module.exports = (server) => {
  const io = new Server(server, {
    cors: {
      origin: process.env.NODE_ENV === 'PROD' ? process.env.PROD_CORS : process.env.DEV_CORS
    }
  })
